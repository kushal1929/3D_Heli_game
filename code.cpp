...
glTranslatef(-20, 2, -6); 
 ...
 renderBitmapString(0, -0.5 / 1.3, 0, GLUT_BITMAP_HELVETICA_18, (char*)"LEVEL  "); 
...
eye_z = radius * sin(theta) * cos(phi); 
 ...
 { 
  ...
  renderBitmapString(move_x, 0 + 4, move_z - 4, GLUT_BITMAP_HELVETICA_18, (char*)"SCORE : "); 
 
  glutBitmapCharacter(GLUT_BITMAP_HELVETICA_18, ((touchx)+48)); 
 
  renderBitmapString(move_x, 0 + 3.8, move_z - 4, GLUT_BITMAP_HELVETICA_18, (char*)"  LEVEL : "); 
...
glScaled(1, 1, 1); 
renderBitmapString(move_x, 5, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)"HELICOPTER 
GAME"); 
BY:"); 
renderBitmapString(move_x, 3.5, move_z + 4, GLUT_BITMAP_HELVETICA_18, (char*)" DEVELOPED 
renderBitmapString(move_x, 2, move_z, GLUT_BITMAP_HELVETICA_18, (char*)"Afza 
shariff(1DB21CS006)"); 
renderBitmapString(move_x, 1, move_z, GLUT_BITMAP_HELVETICA_18, 
(char*)"Bindu.G(1DB21CS026)"); 
renderBitmapString(move_x, 3, move_z, GLUT_BITMAP_HELVETICA_18, (char*)"B N 
Kushal(1DB21CS020)"); 
renderBitmapString(move_x, -1, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)"SPACE TO 
CONTINUE"); 
UP"); 
DOWN"); 
LEFT"); 
...
renderBitmapString(move_x, -2, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)" PRESS 8 FOR 
renderBitmapString(move_x, -3, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)" PRESS 2 FOR 
renderBitmapString(move_x, -4, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)" PRESS 4 FOR 
renderBitmapString(move_x, -5, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)" PRESS 6 FOR 
renderBitmapString(move_x, -6, move_z + 3, GLUT_BITMAP_HELVETICA_18, (char*)" PRESS ESC TO 
glutSwapBuffers(); 
glutPostRedisplay(); 
} 
// Use of double buffering to avoid flicker. 
/****************************************************************************************/ 
